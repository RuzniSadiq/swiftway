				...
				<div class="form-container">
					...
					<!-- Main Heading Ends -->
						...
						<form class="custom-form" method="post" enctype="multipart/form-data">
							...
							<input type="file" name="nic_front" onChange="displayImagef(this)" id="frontImage" class="form-control" style="display: none;" required accept='Member/uploads/NIC front side/*'>
							...
							<input type="file" name="nic_back" onChange="displayImageb(this)" id="backImage" class="form-control" style="display: none;" required accept='Member/uploads/NIC back side/*'>
							...
							<div class="form-group" style="position:relative;bottom:100px">
								...
								<p class="text-center" style="position:relative;top:30px">already have an account ? <a href="user-login.php" style="color:#9acd32">login</a></p>
							</div>
...
if(isset($_POST['RegisterNow'])) {  
		...
		echo '
			...
			$(document).ready(function(){	
				Swal.fire({
					...
					text: "The username that you entered already exists",
					timer: 1700
		...
		<script type="text/javascript">
			$(document).ready(function(){	
				Swal.fire({
					...
					title: "Email Exists",
					showConfirmButton: false,
					text: "The email that you entered already exists",
					timer: 1700
    ...
    $target_dir="Member/uploads/NIC front side/$username - ";
    $target_file=$target_dir . basename($fimage);

	$btarget_dir="Member/uploads/NIC back side/$username - ";
    ...
    //now let we upload the image to the database
		...
		VALUES('$name','$username','$email','$password','$gender','$nicnum','$num','$cus_status','$date','$username - $fimage','$username - $bimage')");
			...
			// echo '</script>';			
			// echo "<script type='text/javascript'> document.location ='user-registration.php'; </script>";
			echo '
			<script type="text/javascript">
				$(document).ready(function(){	
					Swal.fire({
		...
		<script type="text/javascript">
			$(document).ready(function(){	
				Swal.fire({
					...
					title: "Success",
					showConfirmButton: false,
					text: "You have been registered successfully, your account is pending",
					timer: 1700

					...
					<!-- Main Heading Ends -->
						...
						<form class="custom-form" method = "post">
							...
							<div class="form-group">
								...
								<p class="text-center">Already have an account ? <a href="member-login.php" style="color:#9acd32">Login</a>
							</div>
...
if($num>0)
{
		...
		echo '<script language="javascript">';
			echo 'alert("Your account has been recovered successfully")';
			echo '</script>';
			echo "<script type='text/javascript'> document.location ='member-login.php'; </script>";

}else{
	echo '<script language="javascript">';
			echo 'alert("There was an error, please check the provided details")';
			echo '</script>';
}

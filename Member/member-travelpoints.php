...
<div><span class="ZbTJwf" style="position:relative;bottom:20px;right:90px">Earning 1 point per Rs.100</span></div>

<span style="position:relative;left:270px;color:#595959;font-size:16px;bottom:75px"><?php echo $row['cus_travelpoints'];?></span>
<button style="position:relative;left:180px;border:1px solid #dadce0;z-index:100;background-color: transparent;color:#9E6839;bottom:42px"><a href="member-levelbenefits.php" style="text-decoration:none;color:#9E6839 ">Level Benefits</a></button>
...
<div class="ZbTJwf" style="position:relative;right:128px;bottom:10px"><span style="font-weight: bold;"><?php echo $neededpoints; ?></span> pts to <span style="font-weight: bold;"> Silver</span></div>
...
<span style="position:relative;left:270px;color:#595959;font-size:16px;bottom:75px"><?php echo $row['cus_travelpoints'];?></span>
<button style="position:relative;left:180px;border:1px solid #dadce0;z-index:100;background-color: transparent;color:#6F7785;bottom:42px"><a href="member-levelbenefits.php" style="text-decoration:none;color:#858b94 ">Level Benefits</a></button>
...
<span style="color:#f2cf32;font-size:28px;position:relative;bottom:50px;margin-left:450px;margin-top:100px" class="Bzct0b">Gold</span>
<div><span class="ZbTJwf" style="position:relative;bottom:20px;right:82px">Earning 1.2 points per Rs.100</span></div>

<span style="position:relative;left:270px;color:#595959;font-size:16px;bottom:75px"><?php echo $row['cus_travelpoints'];?></span>
<button style="position:relative;left:180px;border:1px solid #dadce0;z-index:100;background-color: transparent;color:#6F7785;bottom:42px"><a href="member-levelbenefits.php" style="text-decoration:none;color:#f2cf32">Level Benefits</a></button>
...
<div><span class="ZbTJwf" style="position:relative;bottom:20px;right:80px">Earning 1.4 points per Rs.100</span></div>

<span style="position:relative;left:270px;color:#595959;font-size:16px;bottom:75px"><?php echo $row['cus_travelpoints'];?></span>
<button style="position:relative;left:180px;border:1px solid #dadce0;z-index:100;background-color: transparent;color:#6F7785;bottom:42px"><a href="member-levelbenefits.php" style="text-decoration:none;color:#6F7785">Level Benefits</a></button>
...
<div class="ZbTJwf" style="position:relative;right:38px;bottom:10px"><span style="font-weight: bold;"><?php //echo $neededpoints; ?></span> pts to stay on platinum through <span style="font-weight: bold;"> 2022</span></div>
        -->
<div><img src="../img/star.gif" style="position:relative;left:170px;bottom:142px;width:125px;height:100px"></div>
      <?php  }

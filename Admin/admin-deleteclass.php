...
<?php
    ...
    $res = mysqli_query($conn, "DELETE FROM trainclass WHERE cl_id='$cl_id'");
	...
	$num = mysqli_affected_rows($conn);
		if($num>0)
		{
			...
			// header("Location:admin-manageclasses.php?pass=$em");
			...
			// header("Location:admin-manageclasses.php?fail=$em");
			echo '<script>
			setTimeout(function() {
				Swal.fire({
				  icon: "error",
